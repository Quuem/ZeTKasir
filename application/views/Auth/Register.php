...
<body class=" d-flex flex-column">
    ...
    <div class="page">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="<?= base_url('Auth/CreateUser') ?>" method="post" autocomplete="off" novalidate>
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">Create new account</h2>
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" name="NamaUser"  value="<?= set_value('NamaUser') ?>" class="form-control" placeholder="Enter name">
                        <?= form_error('NamaUser', '<small class="text-danger">', '</small>') ?>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Username</label>
                        <input type="email" name="Username" readonly class="form-control" placeholder="Enter Username" value="<?= set_value('Username') ?>" >
                        <?= form_error('Username', '<small class="text-danger">', '</small>') ?>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Password</label>
                        <div class="input-group input-group-flat">
                            <input type="password" name="Password" readonly class="form-control" placeholder="Password" autocomplete="off" value="<?= set_value('Password') ?>" >

...
<body class=" d-flex flex-column">
    ...
    <div class="page">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="<?= base_url('Auth/CreateUser') ?>" method="post" autocomplete="off"
                novalidate>
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">Create new account</h2>
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" name="NamaUser" value="<?= set_value('NamaUser') ?>" class="form-control"
                    ...
                    <div class="mb-3">
                        <label class="form-check">
                            ...
                            <span class="form-check-label">Agree the <a
                                    href="<?= base_url('assets') ?>/terms-of-service.html" tabindex="-1">terms and
                                    policy</a>.</span>
                        </label>
                    </div>
